...
对于低版本的es而言，可以选择使用KNN插件[https://opendistro.github.io/for-elasticsearch-docs/docs/knn/approximate-knn/](https://opendistro.github.io/for-elasticsearch-docs/docs/knn/approximate-knn/)，不过我们尝试过在低版本上集成该插件，实际上效果并不好(可能是使用姿势的原因)，建议是直接升级到能够支持向量存储的es版本
