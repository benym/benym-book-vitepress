...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      {
        icon: 'https://img.benym.cn/navimg/boardmix.png',
        title: 'Boardmix',
        desc: '点燃团队协作的空间',
        link: 'https://boardmix.cn/'
      },
      {
        icon: 'https://img.benym.cn/navimg/drawio.png',
        title: 'Draw.io',
        desc: '开源好用的画图工具',
        link: 'https://app.diagrams.net/'
      },
      {
        icon: 'https://img.benym.cn/navimg/excalidraw.png',
        title: 'Excalidraw',
        desc: '开源好用的白板工具',
        link: 'https://excalidraw.com/'
      },
      {
        icon: 'https://img.benym.cn/navimg/convertio.png',
        title: 'Convertio',
        desc: '文件转化器，将您的文件转换成任意格式',
        link: 'https://convertio.co/zh/'
      },
      {
        icon: 'https://img.benym.cn/navimg/codetoimg.png',
        title: 'Codetoimg',
        desc: '将代码转化为彩色图像',
        link: 'https://codetoimg.com/'
      }
    ]
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://img.benym.cn/navimg/chatglm.png',
        title: 'ChatGLM',
        link: 'https://chatglm.cn/detail'
      },
      {
        icon: 'https://img.benym.cn/navimg/doubao.png',
        title: '豆包',
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://img.benym.cn/navimg/tencentcloud.png',
        title: '腾讯云',
        desc: '云服务平台',
      ...
      {
        icon: 'https://img.benym.cn/navimg/vercel.png',
        title: 'Vercel',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://img.benym.cn/navimg/emojipedia.png',
        title: 'Emojipedia',
        desc: 'Emoji 表情大全',
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: '小红书',
        icon: 'https://img.benym.cn/navimg/redbook.png',
        desc: '中文互联网高质量的问答社区和创作者聚集的原创内容平台',
